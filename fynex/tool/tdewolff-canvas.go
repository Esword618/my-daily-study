...
func tdewolff_canvas() {
	...
	w := fyne.CurrentApp().NewWindow("https://hub.fastgit.xyz/tdewolff/canvas")
...
func draw(c *canvas.Context) {
	...
	// Draw a raster image
	lenna, err := os.Open("../image/beauty.jpeg")
	if err != nil {
		panic(err)
	}
...
func triangle() fyne.CanvasObject {

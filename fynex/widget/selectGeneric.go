...
var _ fyne.Widget = (*SelectGeneric)(nil)
var _ desktop.Hoverable = (*SelectGeneric)(nil)
var _ fyne.Tappable = (*SelectGeneric)(nil)
var _ fyne.Focusable = (*SelectGeneric)(nil)
var _ fyne.Disableable = (*SelectGeneric)(nil)
...
func (s *SelectGeneric) CreateRenderer() fyne.WidgetRenderer {
	...
	if s.Selected != nil {
		txtProv = widget.NewRichTextWithText(s.Selected.String())
	} else {
	...
	r := &selectGenRenderer{icon, txtProv, background, line, objects, s}
...
func (s *SelectGeneric) popUpPos() fyne.Position {
...
func (s *SelectGeneric) showPopUp() {
	if s.popUp == nil {
...
func (s *SelectGeneric) tapAnimation() {
	if s.tapAnim == nil {
		return
	}
	s.tapAnim.Stop()
...
func (s *SelectGeneric) updateSelected(text item) {
	s.Selected = text
...
func (s *selectGenRenderer) Objects() []fyne.CanvasObject {
	return s.objects
}

func (s *selectGenRenderer) Destroy() {}

// Layout the components of the button widget
func (s *selectGenRenderer) Layout(size fyne.Size) {
...
func (s *selectGenRenderer) MinSize() fyne.Size {
...
func (s *selectGenRenderer) Refresh() {
	s.combo.propertyLock.RLock()
	s.updateLabel()
	s.updateIcon()
...
func (s *selectGenRenderer) bgLineColor() (bg color.Color, line color.Color) {
	if s.combo.Disabled() {
...
func (s *selectGenRenderer) updateIcon() {
	if s.combo.Disabled() {
...
func (s *selectGenRenderer) updateLabel() {
	...
	if s.combo.Selected == nil {
		...
		s.label.Segments[0].(*widget.TextSegment).Text = s.combo.Selected.String()
	}
	s.label.Refresh()
}
